...
type Speaker struct {
	...
	SessionizeSpeakerID string    `json:"sessionize_speaker_id"`
...
func NewSpeaker(eventID, sessionizeSpeakerID, firstName, lastName, fullName, bio, tagLine, profilePicture string, isTopSpeaker bool, createdAt, updatedAt time.Time) *Speaker {
	return &Speaker{
		EventID:             eventID,
